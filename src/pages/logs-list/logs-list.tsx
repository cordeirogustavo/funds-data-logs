...
const LogsList: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full h-full">
      <div className="bg-[#1B1F25] m-6 mb-0">
          ...
          <div className="flex flex-col">
            <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0.5 lg:space-x-4">
              <div className="flex flex-col">
                ...
                <input type="date" ref={dateRef} className="input p-0.5" />
              </div>
            </div>
      ...
      <div className="flex-1 bg-[#1B1F25] m-6 overflow-auto">
            ...
            <select 
              ...
              onChange={() => {
                if (statusRef.current && statusRef.current.value !== 'all') 
                  return searchOnTable('logsTableBody', statusRef.current.value, true)
                return searchOnTable('logsTableBody', '', false)
              }}
            >
